...
targetdir = paste0("D:/PSCIS_elk_2020_phase1b/")
...
d <- import_pscis(workbook_name = 'pscis_phase1b.xlsm')
...
file.copy(from = 'data/pscis_phase1b.xlsm', to = paste0(targetdir, 'pscis_phase1b.xlsm'))
